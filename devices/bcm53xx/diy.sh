...
sed -i "s/DEVICE_PACKAGES := \$(BRCMFMAC_4366C0) \$(USB3_PACKAGES)/DEVICE_PACKAGES := \$(BRCMFMAC_4366C0) \$(USB3_PACKAGES) -brcmfmac-firmware-4366c0-pcie brcmfmac-firmware-4366c0-pcie-k3 luci-app-k3screenctrl/" target/linux/bcm53xx/image/Makefile

git_clone_path master https://github.com/immortalwrt/immortalwrt package/firmware/brcmfmac4366c0-firmware-k3
